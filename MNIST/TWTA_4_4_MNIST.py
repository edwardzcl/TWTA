...
def model(x, is_train=True, reuse=False):
    ...
    with tf.variable_scope("binarynet", reuse=reuse):
        ...
        net = tl.layers.Conv2d(net, 32, (4, 4), (1, 1), padding='SAME', b_init=None, name='bcnn1')
        ...
        net = tl.layers.TernaryConv2d(net, 32, (2, 2), (2, 2), padding='VALID', b_init=None, name='bcnn2')
        #net = tl.layers.MaxPool2d(net, (2, 2), (2, 2), padding='SAME', name='pool1')
        ...
        net = tl.layers.TernaryConv2d(net, 64, (4, 4), (1, 1), padding='SAME', b_init=None, name='bcnn3')
        ...
        net = tl.layers.TernaryConv2d(net, 64, (4, 4), (1, 1), padding='VALID', b_init=None, name='bcnn5')
        #net = tl.layers.MaxPool2d(net, (2, 2), (2, 2), padding='SAME', name='pool2')
