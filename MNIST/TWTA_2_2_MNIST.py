...
def model(x, is_train=True, reuse=False):
    ...
    with tf.variable_scope("binarynet", reuse=reuse):
        ...
        net = tl.layers.Conv2d(net, 64, (2, 2), (1, 1), padding='SAME', b_init=None, name='bcnn1')
        ...
        net = tl.layers.TernaryConv2d(net, 64, (2, 2), (2, 2), padding='SAME', b_init=None, name='bcnn2')
        #net = tl.layers.MaxPool2d(net, (2, 2), (2, 2), padding='SAME', name='pool1')
        ...
        net = tl.layers.TernaryConv2d(net, 64, (2, 2), (1, 1), padding='SAME', b_init=None, name='bcnn3')
        ...
        net = tl.layers.TernaryConv2d(net, 64, (2, 2), (2, 2), padding='VALID', b_init=None, name='bcnn4')
        #net = tl.layers.MaxPool2d(net, (2, 2), (2, 2), padding='SAME', name='pool2')
        ...
        net = tl.layers.TernaryConv2d(net, 64, (2, 2), (1, 1), padding='VALID', b_init=None, name='bcnn5')
        #net = tl.layers.MaxPool2d(net, (2, 2), (2, 2), padding='SAME', name='pool2')
        ...
        net = tl.layers.TernaryConv2d(net, 64, (2, 2), (2, 2), padding='VALID', b_init=None, name='bcnn6')
        #net = tl.layers.MaxPool2d(net, (2, 2), (2, 2), padding='SAME', name='pool2')
        ...
        net = tl.layers.TernaryConv2d(net, 64, (2, 2), (1, 1), padding='VALID', b_init=None, name='bcnn7')
        #net = tl.layers.MaxPool2d(net, (2, 2), (2, 2), padding='SAME', name='pool2')
        ...
        net = tl.layers.TernaryDenseLayer(net, 512, b_init=None, name='dense')
