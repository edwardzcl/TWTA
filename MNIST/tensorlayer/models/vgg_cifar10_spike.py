...
def VGG_CIFAR10_spike(x_crop, y_, pretrained=False, end_with='fc1000', n_classes=1000, is_train=True, reuse=False, name=None):
    ...
    with tf.variable_scope("model", reuse=reuse):
         ...
         net = DorefaConv2d(net, n_filter=64, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv0')
         ...
         net = DorefaConv2d(net, n_filter=64, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv1')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn1')
         net = SignLayer(net)

         spikes = spikes + tf.reduce_sum(net.outputs)*1*1*64

         net = DorefaConv2d(net, n_filter=64, filter_size=(2, 2), strides=(2, 2), padding='SAME', b_init=None, name='conv2')
         ...
         net = DorefaConv2d(net, n_filter=128, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv3')
         ...
         net = DorefaConv2d(net, n_filter=128, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv4')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn4')
         net = SignLayer(net)

         spikes = spikes + tf.reduce_sum(net.outputs)*1*1*128

         net = DorefaConv2d(net, n_filter=128, filter_size=(2, 2), strides=(2, 2), padding='SAME', b_init=None, name='conv5')
         ...
         net = DorefaConv2d(net, n_filter=256, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv6')
         ...
         net = DorefaConv2d(net, n_filter=256, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv7')
         ...
         net = DorefaConv2d(net, n_filter=256, filter_size=(2, 2), strides=(2, 2), padding='SAME', b_init=None, name='conv8')
         ...
         net = DorefaConv2d(net, n_filter=512, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv9')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn9')
         net = SignLayer(net)

         spikes = spikes + tf.reduce_sum(net.outputs)*1*1*512

         net = DorefaConv2d(net, n_filter=512, filter_size=(3, 3), strides=(1, 1), padding='VALID', b_init=None, name='conv10')
