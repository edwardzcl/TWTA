...
def Resnet18_full_conv5(x_crop, y_, pretrained=False, end_with='fc1000', n_classes=1000, is_train=True, reuse=False, name=None):
    ...
    with tf.variable_scope("model", reuse=reuse):
         ...
         #可以考虑要不要bn等
         #反过来，把长阶段的加到短阶段中，并且可以有很多取舍，很多组合
         ...
         net1 = BatchNormLayer(net1, act=tf.identity, is_train=is_train,  name='stage1bn3')
         ...
         net3 = BatchNormLayer(net3, act=tf.identity, is_train=is_train,  name='stage3bn3')
         ...
         net5 = BatchNormLayer(net5, act=tf.identity, is_train=is_train,  name='stage5bn3')
