...
with tf.device('/cpu:0'):
    ...
    def model(x_crop, y_, is_train, reuse):
        ...
        with tf.variable_scope("model", reuse=reuse):
            ...
            net = tl.layers.TernaryConv2d(net, 64, (4, 4), (1, 1), padding='SAME', b_init=None, name='cnn0')
            #net = tl.layers.MaxPool2d(net, (3, 3), (2, 2), padding='SAME', name='pool0')
            ...
            net2=[]
            for i in range(16):
                net2.append(tl.layers.TernaryConv2d(net[:,:,:,i::16], 32, (4, 4), (1, 1), padding='SAME', b_init=None, name='cnn2_'+str(i+1)))
            ...
            net6=[]
            for i in range(32):
                net6.append(tl.layers.TernaryConv2d(net[:,:,:,i::32], 64, (4, 4), (1, 1), padding='SAME', b_init=None, name='cnn6_'+str(i+1)))
            ...
            net8=[]
            for i in range(16):
                net8.append(tl.layers.TernaryConv2d(net[:,:,:,i::16], 64, (4, 4), (2, 2), padding='VALID', b_init=None, name='cnn8_'+str(i+1)))
