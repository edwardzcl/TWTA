...
with tf.device('/cpu:0'):
    ...
    def model(x_crop, y_, is_train, reuse):
        ...
        with tf.variable_scope("model", reuse=reuse):
            ...
            net = tl.layers.TernaryConv2d(net, n_filter=64, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv0')
            net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train,  name='bn0')
            net = tl.layers.TernaryLayer(net, name='ternary0')

            net = tl.layers.TernaryConv2d(net, n_filter=64, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv1')
            ...
            net = tl.layers.TernaryConv2d(net, n_filter=128, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv3')
            net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train,  name='bn3')
            net = tl.layers.TernaryLayer(net, name='ternary3')

            net = tl.layers.TernaryConv2d(net, n_filter=128, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv4')
            ...
            net = tl.layers.TernaryConv2d(net, n_filter=256, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv6')
            net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train,  name='bn6')
            net = tl.layers.TernaryLayer(net, name='ternary6')

            net = tl.layers.TernaryConv2d(net, n_filter=256, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv7')
            net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train,  name='bn7')
            net = tl.layers.TernaryLayer(net, name='ternary7')

            net = tl.layers.TernaryConv2d(net, n_filter=256, filter_size=(2, 2), strides=(2, 2), padding='SAME', b_init=None, name='conv8')
            net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train,  name='bn8')
            net = tl.layers.TernaryLayer(net, name='ternary8')

            net = tl.layers.TernaryConv2d(net, n_filter=512, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv9')
            net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train,  name='bn9')
            net = tl.layers.TernaryLayer(net, name='ternary9')

            net = tl.layers.TernaryConv2d(net, n_filter=512, filter_size=(3, 3), strides=(1, 1), padding='VALID', b_init=None, name='conv10')
