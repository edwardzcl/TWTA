...
def Resnet18_full(x_crop, y_, pretrained=False, end_with='fc1000', n_classes=1000, is_train=True, reuse=False, name=None):
    ...
    with tf.variable_scope("model", reuse=reuse):
         ...
         net1 = DorefaConv2d(net, n_filter=64, filter_size=(3, 3), strides=(2, 2), padding='SAME', b_init=None, name='stage1conv1')
         net1 = BatchNormLayer(net1, act=tf.nn.relu, is_train=is_train,  name='stage1bn1')
         net1 = SignLayer(net1)
         net1 = DorefaConv2d(net1, n_filter=64, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='stage1conv2')
         shortcut = DorefaConv2d(net, n_filter=64, filter_size=(3, 3), strides=(2, 2), padding='SAME', b_init=None, name='shortcut1conv1')
         ...
         shortcut = net1
         net2 = DorefaConv2d(net1, n_filter=64, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='stage2conv1')
         net2 = BatchNormLayer(net2, act=tf.nn.relu, is_train=is_train,  name='stage2bn1')
         net2 = SignLayer(net2)
         net2 = DorefaConv2d(net2, n_filter=64, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='stage2conv2')
         ...
         net3 = DorefaConv2d(net2, n_filter=128, filter_size=(3, 3), strides=(2, 2), padding='SAME', b_init=None, name='stage3conv1')
         net3 = BatchNormLayer(net3, act=tf.nn.relu, is_train=is_train,  name='stage3bn1')
         net3 = SignLayer(net3)
         net3 = DorefaConv2d(net3, n_filter=128, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='stage3conv2')
         shortcut = DorefaConv2d(net2, n_filter=128, filter_size=(3, 3), strides=(2, 2), padding='SAME', b_init=None, name='shortcut3conv1')
         net3 = ElementwiseLayer([shortcut, net3], combine_fn=tf.add, act=None, name='elementwise3')
         net3 = BatchNormLayer(net3, act=tf.nn.relu, is_train=is_train,  name='stage3bn3')
         #也确实不太适合在这里加shortcut，一来妨碍BN_ReLu的融合，二来在这里加，已经在上面的BN层的ReLu之后，并且妨碍下一层的限幅
         net3 = SignLayer(net3)

         shortcut = net3
         net4 = DorefaConv2d(net3, n_filter=128, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='stage4conv1')
         net4 = BatchNormLayer(net4, act=tf.nn.relu, is_train=is_train,  name='stage4bn1')
         net4 = SignLayer(net4)
         net4 = DorefaConv2d(net4, n_filter=128, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='stage4conv2')
         ...
         net4 = BatchNormLayer(net4, act=tf.nn.relu, is_train=is_train,  name='stage4bn3')
         #也确实不太适合在这里加shortcut，一来妨碍BN_ReLu的融合，二来在这里加，已经在上面的BN层的ReLu之后，并且妨碍下一层的限幅
         net4 = SignLayer(net4)

         net5 = DorefaConv2d(net4, n_filter=256, filter_size=(3, 3), strides=(2, 2), padding='SAME', b_init=None, name='stage5conv1')
         net5 = BatchNormLayer(net5, act=tf.nn.relu, is_train=is_train,  name='stage5bn1')
         net5 = SignLayer(net5)
         net5 = DorefaConv2d(net5, n_filter=256, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='stage5conv2')
         shortcut = DorefaConv2d(net4, n_filter=256, filter_size=(3, 3), strides=(2, 2), padding='SAME', b_init=None, name='shortcut5conv1')
         net5 = ElementwiseLayer([shortcut, net5], combine_fn=tf.add, act=None, name='elementwise5')
         net5 = BatchNormLayer(net5, act=tf.nn.relu, is_train=is_train,  name='stage5bn2')
         #也确实不太适合在这里加shortcut，一来妨碍BN_ReLu的融合，二来在这里加，已经在上面的BN层的ReLu之后，并且妨碍下一层的限幅
         net5 = SignLayer(net5)    

         shortcut = net5
         net6 = DorefaConv2d(net5, n_filter=256, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='stage6conv1')
         net6 = BatchNormLayer(net6, act=tf.nn.relu, is_train=is_train,  name='stage6bn1')
         net6 = SignLayer(net6)
         net6 = DorefaConv2d(net6, n_filter=256, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='stage6conv2')
         ...
         net6 = BatchNormLayer(net6, act=tf.nn.relu, is_train=is_train,  name='stage6bn2')
         #也确实不太适合在这里加shortcut，一来妨碍BN_ReLu的融合，二来在这里加，已经在上面的BN层的ReLu之后，并且妨碍下一层的限幅
         net6 = SignLayer(net6)     

         net7 = DorefaConv2d(net6, n_filter=512, filter_size=(3, 3), strides=(1, 1), padding='VALID', b_init=None, name='conv7')
